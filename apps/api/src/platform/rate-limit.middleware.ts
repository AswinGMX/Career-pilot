...
const RATE_LIMIT_RULES: RateLimitRule[] = [
  ...
  { id: "auth-otp-send", methods: ["POST"], prefix: "/v1/auth/otp/send", limit: 5, windowMs: 10 * 60_000 },
  { id: "auth-otp-verify", methods: ["POST"], prefix: "/v1/auth/otp/verify", limit: 10, windowMs: 10 * 60_000 },
